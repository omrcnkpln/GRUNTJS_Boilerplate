<?php
include("ayarlar.php");
//eger admin ise diger sayfaya girmesin degilse admine giremesin
...
if ($_POST) {
    ...
    if (!empty($mail) && !empty($sifre)) {
        ...
        if ($verify_user > 0) {
            if ($mail == 'omrcnkpln@gmail.com') {

                session_start();
                //büyüktür bu yüzden lazım galiba

                $info = mysqli_fetch_array($find_user);
                ...
                echo "admin panele hoşgeldiniz !!";

                header("refresh:2; url = nedmin/index.php");
